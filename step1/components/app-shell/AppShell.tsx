...
export function AppShell({ contextValue }: AppShellProps): React.ReactElement {
  ...
  const showRightPanel = (appMode === 'agent' && !!currentSessionId) || appMode === 'wizard'
  ...
  return (
    <AppShellProvider value={contextValue}>
      ...
      <div className="shell-bg h-screen w-screen flex overflow-hidden bg-gradient-to-br from-zinc-50 to-zinc-100 dark:from-zinc-950 dark:to-zinc-900">
        ...
        {/* 右侧面板：wizard 模式显示预览，agent 模式显示文件面板 */}
        {showRightPanel && appMode === 'wizard' && (
          <div className="relative z-[60] flex items-stretch p-2 pl-0">
            <div
            ...
            />
            <WizardPreviewPanel width={clampedRightPanelWidth} />
          </div>
        )}
        {showRightPanel && appMode === 'agent' && (
