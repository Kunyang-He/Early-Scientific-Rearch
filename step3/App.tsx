...
import { WizardLayout } from './components/preview/WizardLayout'
...
export default function App(): React.ReactElement {
  ...
  // 显示 onboarding 界面（wizard 模式跳过 onboarding）
  if (showOnboarding && appMode !== 'wizard') {
    return (
